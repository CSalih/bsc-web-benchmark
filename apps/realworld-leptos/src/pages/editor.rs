                                ...
                                result
                                    .with(|x| {
                                        ...
                                        match x {
                                            ...
                                            Ok(EditorResponse::UpdateError) => {
                                                "Error while updating the article, please, try again later"
                                                    .into()
                                            }
                                            Ok(EditorResponse::Successful(_)) => String::new(),
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <fieldset class="form-group">
                                                                <textarea
                                                                    ...
                                                                    prop:value=a.article.body.unwrap_or_default()
                                                                ></textarea>
                                                            </fieldset>
                                                            <fieldset class="form-group">
                                                                <input
